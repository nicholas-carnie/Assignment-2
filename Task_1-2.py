...
print("Welcome to the Multiplication Table.\n")             #Print function - Welcome message
print("To get the multiplication of a number.\n")           #Print function - Purpose of program

multiple = 1                                                #Assign the variable: Integer '2' into variable 'multiple'
...
for x in range(10):                                         #Intilize for loop with placeholder 'x' in range function. Range executes 9 times only.
    ...
    multiple += 1                                           #Sets new value for variable 'multiple' as 'multiple + integer 1'
