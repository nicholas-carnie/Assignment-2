...
print("The sum of the numbers from 1 to 10 is",sum) #Print function is called when for loop is exhausted. The loop has passed 10 times to give a final value for sum = 55.
